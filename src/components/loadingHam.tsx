...
function LoadingHam() {
  return (
    <>
        <svg xmlns="http://www.w3.org/2000/svg" width="100" height="100" viewBox="0 0 24 24" fill="hsl(var(--background))" stroke='hsl(var(--muted-foreground))' stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round" 
