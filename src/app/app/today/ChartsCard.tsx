...
export default function ChartsCards({ values, objective, date} : { values : MealValues, objective : Objective, date : Date}) {
    return(
        <Card className="overflow-scroll no-scrollbar xl:min-w-80">
            <CardHeader className="pb-2 md:text-center font-semibold">
                {date.toLocaleString("en-GB", {month : 'long', day : 'numeric', year : 'numeric'})}
            </CardHeader>
            <CardContent className="flex flex-col pb-2 md:pb-6 md:gap-6">
